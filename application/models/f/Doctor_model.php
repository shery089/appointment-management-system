<?php  
	class Doctor_model extends CI_Model {
        ...
        public function insert_doctor($image)
        {
            ...
            $this->description = html_escape(strtolower(trim($this->db->escape($this->input->post('description')), "''")));
            ...
            $this->fee = html_escape(trim($this->db->escape($this->input->post('fee')), "''"));
        ...
        public function get_doctor_by_specialization()
        {
            ...
            if(!empty($specialization))
            {
                ...
                {                    
                    $this->db->select('doctor.*, GROUP_CONCAT(`doctor_specialization`.`name` SEPARATOR ", " ) AS specialization');

                    $this->db->from('doctor');
                    
                    $this->db->where_in('doctor_specialization.id', $specialization);
                ...
                else
                {
                    ...
                    $this->db->where('doctor_specialization.id', $specialization[0]);
