<?php  
    class Patient_model extends CI_Model {
        ...
        {   
            ...
            $this->db->select('patient.id, patient.mr_number, patient.first_name, patient.middle_name, patient.last_name, patient.email, patient.mobile_number, patient.father_name');
            
            $this->db->from('patient');
            
            if(!empty($father_name) && !empty($mr_number) && !empty($mobile_number))
            {
