				...
				<table class="table table-bordered table-responsive table-striped table">
				    ...
				    <?php foreach ($appointments as $appointment): ?>
				    	<tr>
				   			...
				   			<td>
				   				<a href="appointment/edit_appointment_lookup/<?=  $appointment['id']; ?>" class="btn btn-sm btn-success actions"><span class="glyphicon glyphicon-pencil"></span></a>
								<a href="#" onclick="getModal(<?= $appointment['id']; ?>, 'delete', 'appointment')" class="btn btn-sm btn-danger actions"><span class="glyphicon glyphicon-remove-sign"></span></a>
				   				<a href="#" onclick="getModal(<?= $appointment['id']; ?>, 'view', 'appointment')" class="btn btn-sm btn-info actions"><span class="fa fa-eye"></span></a>
				   				<a href="#" onclick="getModal(<?= $appointment['id']; ?>, 'add', 'prescription')" class="btn btn-sm btn-primary actions"><span class="fa fa-file-text-o"></span></a>
				   			</td>
				   		</tr>
					<?php endforeach; ?>
				    </tbody>
